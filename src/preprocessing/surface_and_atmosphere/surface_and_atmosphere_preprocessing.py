...
# Adverse weather flag: codes 2=Raining,3=Snowing,4=Fog,5=Smoke,6=Dust,7=Strong winds
atm_df["ADVERSE_WEATHER"] = atm_df["ATMOSPH_COND"].isin([2, 3, 4, 5, 6, 7]).astype(int)

# One-hot encode the ATMOSPH_COND categories
